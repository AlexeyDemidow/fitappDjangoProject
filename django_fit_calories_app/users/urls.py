...
a = 'D:/ITacademy/fitappDjangoProject/django_fit_calories_app/templates/registration/password_reset_email.html'
...
urlpatterns = [
    ...
    path('password_reset/', views.PasswordResetView.as_view(html_email_template_name=a), name='password_reset'),  # Смена пароля
